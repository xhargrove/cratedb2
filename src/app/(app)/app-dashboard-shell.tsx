...
/**
 * Session guard + chrome live here (not in `layout.tsx`) so failures surface in
 * `(app)/error.tsx`. Next.js does not run a segment's `error.tsx` for errors thrown
 * in that segment's layout file.
 */
export async function AppDashboardShell({
  children,
}: {
